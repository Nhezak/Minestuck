...
public class AlchemyRecipes
{
	...
	{/*
		...
		AlchemyCostRegistry.addGristConversion(BEEF_SWORD, new GristSet(new GristType[] {GristType.IODINE}, new int[] {55}));
		AlchemyCostRegistry.addGristConversion(IRRADIATED_STEAK_SWORD, new GristSet(new GristType[] {GristType.IODINE, GristType.TAR, GristType.URANIUM}, new int[] {55, 10, 8}));
