...
public class ConsortRewardHandler
{
	...
	public static void registerMinestuckPrices()
	{
		...
		ConsortRewardHandler.registerPrice(new ItemStack(GLOWING_MUSHROOM.get()), 10, 15);
		ConsortRewardHandler.registerPrice(new ItemStack(COLD_CAKE.get()), 400, 400);
		ConsortRewardHandler.registerPrice(new ItemStack(BLUE_CAKE.get()), 400, 400);
		ConsortRewardHandler.registerPrice(new ItemStack(HOT_CAKE.get()), 400, 400);
		ConsortRewardHandler.registerPrice(new ItemStack(RED_CAKE.get()), 400, 400);
		ConsortRewardHandler.registerPrice(new ItemStack(FUCHSIA_CAKE.get()), 1500, 1500);
		...
		ConsortRewardHandler.registerPrice(new ItemStack(GOLD_SEEDS.get()), 300, 400);
		ConsortRewardHandler.registerPrice(new ItemStack(APPLE_CAKE.get()), 100, 140);
		...
		ConsortRewardHandler.registerPrice(new ItemStack(MINI_FROG_STATUE.get()), 200, 250);
		...
		ConsortRewardHandler.registerPrice(new ItemStack(GLOWING_LOG.get()), 20, 32);
		ConsortRewardHandler.registerPrice(new ItemStack(GLOWING_PLANKS.get()), 5, 8);
		ConsortRewardHandler.registerPrice(new ItemStack(COARSE_STONE.get()), 5, 8);
		ConsortRewardHandler.registerPrice(new ItemStack(CHISELED_COARSE_STONE.get()), 8, 15);
		ConsortRewardHandler.registerPrice(new ItemStack(SHADE_BRICKS.get()), 5, 8);
		ConsortRewardHandler.registerPrice(new ItemStack(SMOOTH_SHADE_STONE.get()), 5, 8);
		ConsortRewardHandler.registerPrice(new ItemStack(FROST_BRICKS.get()), 5, 8);
		ConsortRewardHandler.registerPrice(new ItemStack(FROST_TILE.get()), 5, 8);
		ConsortRewardHandler.registerPrice(new ItemStack(CAST_IRON.get()), 5, 8);
		ConsortRewardHandler.registerPrice(new ItemStack(CHISELED_CAST_IRON.get()), 8, 15);
		ConsortRewardHandler.registerPrice(new ItemStack(VINE_LOG.get()), 20, 32);
		ConsortRewardHandler.registerPrice(new ItemStack(FLOWERY_VINE_LOG.get()), 25, 40);
		ConsortRewardHandler.registerPrice(new ItemStack(FROST_LOG.get()), 20, 32);
		ConsortRewardHandler.registerPrice(new ItemStack(WOODEN_CACTUS.get()), 50, 60);
		ConsortRewardHandler.registerPrice(new ItemStack(SUGAR_CUBE.get()), 200, 240);
